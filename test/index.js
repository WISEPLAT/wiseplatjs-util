...
var wshUtils = require('../dist/index.js')
...
describe('zero address', function () {
  it('should generate a zero address', function () {
    var zeroAddress = wshUtils.zeroAddress()
...
describe('is zero address', function () {
  it('should return true when a zero address is passed', function () {
    var isZeroAddress = wshUtils.isZeroAddress('0x0000000000000000000000000000000000000000')
  ...
  it('should return false when the address is not equal to zero', function () {
    ...
    assert.equal(wshUtils.isZeroAddress(nonZeroAddress), false)
  })
})
...
describe('isPrecompiled', function () {
  it('should return true', function () {
    ...
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000005'), true)
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000006'), true)
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000007'), true)
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000008'), true)
    assert.equal(wshUtils.isPrecompiled(Buffer.from('0000000000000000000000000000000000000001', 'hex')), true)
  })
  it('should return false', function () {
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000000'), false)
    assert.equal(wshUtils.isPrecompiled('0000000000000000000000000000000000000009'), false)
    assert.equal(wshUtils.isPrecompiled('1000000000000000000000000000000000000000'), false)
    assert.equal(wshUtils.isPrecompiled(Buffer.from('0000000000000000000000000000000000000000', 'hex')), false)
  })
})
...
describe('toBuffer', function () {
  it('should work', function () {
    ...
    // 'toArray'
    assert.deepEqual(wshUtils.toBuffer({ toArray: function () { return [ 1 ] } }), Buffer.from([1]))
  })
...
describe('.isValidAddress()', function () {
  ...
  it('should return false', function () {
    ...
    assert.equal(wshUtils.isValidAddress('0X52908400098527886E0F7030069857D2E4169EE7'), false)
